/** Official Green Logistics Broker–Carrier Agreement text (from company PDF template). */
export const GREEN_LOGISTICS_AGREEMENT_V2 = `GREEN LOGISTICS LLC
121 Frog Hollow Rd, Churchville, PA 18966
Ph (267) 703-5313

BROKER – CARRIER AGREEMENT

This agreement was entered into between Green Logistics LLC, MC # 1237784, and the undersigned Carrier (MC# as provided in the Carrier Profile), hereinafter referred to as Carrier.
...
2.1 CANCELLATION FEE. In the event that the Carrier cancels a scheduled shipment after confirmation, a cancellation fee of $50 shall apply. The cancellation fee shall be deducted from any amounts owed to the Carrier for services rendered, or the Carrier shall remit the cancellation fee to the Broker within five (5) business days of the cancellation.
...
4. Insurance. Carrier agrees to provide any insurance coverages required by any government body for the types of transportation and related services specified in load confirmation communications received from Broker. All insurance required by this Agreement must be written by an insurance company having a Best’s rating of “B+” VII or better and must be authorized to do business under the laws of the state(s) or province(s) in which Carrier provides the transportation and related services. Carrier’s insurance shall be primary. Carrier shall at all times have and maintain: (i) Motor Truck Cargo insurance with limits never less than US$100,000 per shipment; (ii) Commercial Automobile Liability insurance with a combined single limit of not less than US$1,000,000 per occurrence; (iii) Commercial General Liability insurance not less than US$1,000,000 per occurrence; (iv) Worker’s Compensation insurance as required by statute and Employer’s Liability not less than US$500,000; and (v) hazardous materials coverages when applicable. Broker shall be named as certificate holder. Broker shall be notified in writing at least thirty (30) days prior to cancellation, change or non-renewal.

5. Carrier Moving Perishables. Carrier warrants inspection and maintenance of refrigeration/heating units as set forth in the full Agreement, and assumes liability for failure to maintain adequate fuel levels.

6. Shipping Document Execution. Carrier is to be named on the bill of lading as the “carrier of record.”

6.1 BILL OF LADING. The Bills of Lading (BOL) shall include, at a minimum, the shipper's and consignee's names and addresses, a description of the vehicles/cargo being transported, the origin and destination of the shipment, and any other information required by law or requested by the Broker. The Carrier shall promptly provide the Bills of Lading to the Broker upon pickup and completion of each shipment.

7. INDEMNIFICATION. CARRIER WILL INDEMNIFY, DEFEND AND HOLD HARMLESS BROKER, ITS AFFILIATES AND ITS CUSTOMERS FROM ANY AND ALL LOSSES ARISING OUT OF OR IN CONNECTION WITH THE TRANSPORTATION SERVICES PROVIDED UNDER THIS CONTRACT.

8. Carrier’s Cargo Liability. Carrier assumes full liability for the greater of replacement cost, Shipper’s/Consignor’s commercial invoice or market value for loss, damage or destruction of any and all goods or property tendered to Carrier by Broker, and for the full course of carriage.

9. Governing Law. Consent to Jurisdiction and Integration. This Contract will be construed, to the extent not preempted by applicable federal law, under the laws of the State of California. Broker and Carrier waive all right to trial by jury. Exclusive jurisdiction: federal or state courts sitting in California.
...
10. Confidentiality Obligations. During this Contract’s term and for 12 months after its termination, Carrier will hold proprietary Broker information in confidence.

10.1 Non Solicitation of Customers. During this Contract’s term and for 9 months after its termination, Carrier will not solicit Broker Customers as defined in the full Agreement (commission 10% / max US$200 per shipment if violated).

11. Savings Clause. If any provision is held invalid, the remainder remains in force.

12. Term. This Agreement shall be for the period of one (1) year and shall be automatically renewed unless cancelled. Either party may terminate upon fifteen (15) days written notice. By signatory hereto, CARRIER represents that it has the authority and ability to enter into legally binding contracts and agrees to be bound by the terms and conditions of this Agreement effective immediately.
